...
parser.add_option('-s',                                 dest="subSamples",      default="0,1,2,3,4,5", help="Year or comma separated list of subsamples")
...
if o.doWeights:
    ...
    for y in years:
        ...
        cmds.append(weightCMD+" -d "+outputDirNom+"/data"+y+"/"+histName+" -c passPreSel   -o "+outputDir+"/weights/noTT_data"+y+"_b0p6_PreSel/  -r SB -w 00-00-02")
...
jcmFileList = {}
jcmFileList["2018"] = outputDir+"/weights/noTT_data2018_b0p6_PreSel/jetCombinatoricModel_SB_00-00-02.txt"
jcmFileList["2017"] = outputDir+"/weights/noTT_data2017_b0p6_PreSel/jetCombinatoricModel_SB_00-00-02.txt"
jcmFileList["2016"] = outputDir+"/weights/noTT_data2016_b0p6_PreSel/jetCombinatoricModel_SB_00-00-02.txt"
...
if o.subSample3b:
    ...
    for s in subSamples:
        ...
        for y in years:
            ...
            cmds.append(runCMD+" -i "+outputDirNom+"/fileLists/data"+y+".txt"+ picoOut + " -o "+outputDir+ yearOpts[y]+  h10+  histOut + " -j "+jcmFileList[y]+" --emulate4bFrom3b --emulationOffset "+s+" --noDiJetMassCutInPicoAOD ")
            logs.append(outputDir+"/log_dataOnlyAll_make3b_"+y+"_b0p6_v"+s)

            for tt in ttbarSamples:
                cmds.append(runCMD+" -i "+outputDirNom+"/fileLists/"+tt+y+"_noMjj.txt" + picoOut + " -o "+outputDir + MCyearOpts[y] +h10 + histOut + " -j "+jcmFileList[y]+" --emulate4bFrom3b --emulationOffset "+s+" --noDiJetMassCutInPicoAOD")
...
if o.histSubSample3b:
    ...
    for s in subSamples:
        ...
        for y in years:
            ...
            cmds.append(runCMD+" -i "+outputDir+"/data"+y+"/"+picoIn + picoOut +" -o "+outputDir+ yearOpts[y] + h10 + histOut + " --is3bMixed  --writeEventTextFile ")
...
if o.make4bHemis:
    ...
    for y in years:
        ...
        cmds.append(runCMD+" -i "+outputDirNom+"/fileLists/data"+y+".txt"+ picoOut + " -o "+outputDir+"/dataHemis_b0p6"+ yearOpts[y]+  h1 +  histOut + " --createHemisphereLibrary")

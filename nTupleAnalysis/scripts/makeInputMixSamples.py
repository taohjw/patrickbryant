...
parser.add_option('--writeOutDvT3Weights',  action="store_true",      help="Copy 3b subsampled data to eos ")
...
if o.inputsForDataVsTT:
    ...
    for y in years:
        ...
        if not o.doTTbarPtReweight: condor_jobs.append(makeCondorFile(cmd, EOSOUTDIR, "data"+y+"_"+tagID, outputDir=outputDir, filePrefix="inputsForDataVsTT_convert_4b_"))

        cmd = convertToH5JOB+" -i "+getOutDir()+"/data"+y+"_"+tagID+"/"+pico3b+"  -o "+pico3b_h5
        if not o.doTTbarPtReweight: condor_jobs.append(makeCondorFile(cmd, EOSOUTDIR, "data"+y+"_"+tagID, outputDir=outputDir, filePrefix="inputsForDataVsTT_convert_3b_"))
...
if o.copyLocally: 
    ...
    if o.doTTbarPtReweight:
        picoAOD_4b = "picoAOD_4b_"+tagID+"_rwTT.h5"
        picoAOD_3b = "picoAOD_3b_"+tagID+"_rwTT.h5"
        ...
        for y in ["2018","2017","2016"]:
            ...
            for tt in ttbarSamples:
                if not o.doTTbarPtReweight:
                    ...
                    scp("closureTests/mixed/"+tt+y+"_"+tagID+"/picoAOD_3b_"+tagID+"_rwTT.h5", "closureTests/"+dirName+"/"+tt+y+"_"+tagID+"/picoAOD_3b_"+tagID+"_rwTT.h5")
                    scp("closureTests/mixed/"+tt+y+"_"+tagID+"/picoAOD_4b_"+tagID+"_rwTT.h5", "closureTests/"+dirName+"/"+tt+y+"_"+tagID+"/picoAOD_4b_"+tagID+"_rwTT.h5")
...
if o.copyWeightsToEOS:
    ...
    picoAOD_3b = "picoAOD_3b_"+tagID+"_DvT3_rwTT.h5"
    ...
    for y in years:
        ...
        for tt in ttbarSamples:
            ...
            #cpLocal(EOSOUTDIR, outputDir, tt+y+"_"+tagID, picoAOD_4b)
            cpEOS(EOSOUTDIR, outputDir, tt+y+"_"+tagID, picoAOD_3b_tt)
...
if o.writeOutDvT3Weights: 
    ...
    for y in years:
        ...
        for tt in ttbarSamples:
            cmd = convertToROOTWEIGHTFILE+" -i "+getOutDir()+"/"+tt+y+"_"+tagID+"/"+picoAOD_3b_tt+"    --classifierName DvT3      --fvtNameList "+weightList
...
if o.makeDvT3FileLists:
    ...
    for y in years:
        ...
        picoNameDvT3b = "picoAOD_3b_"+tagID+"_DvT3_rwTT_weights_.root"
        ...
        fileList = outputDirNom+"/fileLists/data"+y+"_"+tagID+"_3b_DvT3_rwTT.txt"    
        run("rm "+fileList)
        ...
        for tt in ttbarSamples:
            ...
            fileList = outputDirNom+"/fileLists/"+tt+y+"_"+tagID+"_3b_DvT3_rwTT.txt"    
            run("rm "+fileList)
            run("echo "+EOSOUTDIR+"/"+tt+y+"_"+tagID+"/"+picoNameDvT3b_tt+" >> "+fileList)
...
if o.makeDvT4FileLists:
    ...
    for y in years:
        ...
        #  3b 
        #
        picoName4b    = "picoAOD_4b_b0p60p3.root"
        picoNameDvT4b = "picoAOD_4b_b0p60p3_DvT3_weights_.root"

        fileList = outputDirNom+"/fileLists/data"+y+"_"+tagID+"_4b.txt"    
        run("rm "+fileList)
        run("echo "+EOSOUTDIR+"/data"+y+"_"+tagID+"/"+picoName4b+" >> "+fileList)

        #fileList = outputDirNom+"/fileLists/data"+y+"_"+tagID+"_4b_DvT4.txt"    
        #run("rm "+fileList)
        ...
        for tt in ttbarSamples:
            ...
            #fileList = outputDirNom+"/fileLists/"+tt+y+"_"+tagID+"_4b_DvT4.txt"    
            #run("rm "+fileList)
...
if o.testDvTWeights:
    ...
    histDetail3b        = " --histDetailLevel allEvents.passMDRs.threeTag.failrWbW2 "
    histDetail4b        = " --histDetailLevel allEvents.passMDRs.fourTag.failrWbW2 "
    ...
    if o.doDvTReweight:
        histName3b = "hists_3b_"+tagID+"_rwDvT_rwTT.root"
        histName4b = "hists_4b_"+tagID+"_rwDvT_rwTT.root"
    ...
    for y in years:
        ...
        inputWeights = " " #" --inputWeightFilesDvT "+outputDirNom+"/fileLists/data"+y+"_"+tagID+"_3b_DvT3.txt "
        DvTName4b = " " #" --reweightDvTName weight_DvT3_3b_pt3 "
        ...
        inputWeights = " --inputWeightFilesDvT "+outputDirNom+"/fileLists/data"+y+"_"+tagID+"_3b_DvT3_rwTT.txt "
        ...
        if not o.doDvTReweight:
            ...
            for tt in ttbarSamples:
                ...
                inputWeights = " " # --inputWeightFilesDvT "+outputDirNom+"/fileLists/"+tt+y+"_"+tagID+"_3b_DvT3.txt "
                ...
                inputWeights = " --inputWeightFilesDvT "+outputDirNom+"/fileLists/"+tt+y+"_"+tagID+"_3b_DvT3_rwTT.txt "

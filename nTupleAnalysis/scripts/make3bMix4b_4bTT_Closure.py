...
if o.mixInputs:
    ...
    if o.condor:
        ...
        if o.email: execute('echo "Subject: [make3bMix4b_4bTT_Closure] mixInputs  Done" | sendmail '+o.email,doRun)
...
if o.makeInputFileLists:
    ...
    for y in years:
        ...
        #
        for s in subSamples:
            fileList = outputDir+"/fileLists/mixed"+y+"_"+mixedName+"_"+tagID+"_v"+s+".txt"    
            run("rm "+fileList)
            ...
            for tt in ttbarSamples:
                ...
                run("echo "+eosDirTTbar+"/"+tt+y+"_noMjj_"+tagID+"/picoAOD_4bPseudoData_"+tagID+".root >> "+fileList)
...
if o.histsForJCM: 
    ...
    for s in subSamples:
        ...
        if "2016" in years and "2017" in years and "2018" in years:
            ...
            mkdir(outputDir+"/mixedRunII",   doRun)
            ...
            cmd = "hadd -f " + getOutDir()+"/mixedRunII_"+mixedName+"_"+tagID+"_v"+s+"/"+ histName+" "
            for y in years:
                cmd += getOutDir()+"/mixed"+y+"_"+mixedName+"_"+tagID+"_v"+s+"/"  +histName+" "

        if o.condor:
            condor_jobs.append(makeCondorFile(cmd, "None", "mixedRunII_v"+s, outputDir=outputDir, filePrefix="histsForJCM_v"+s))            
        else:
            cmds.append(cmd)
            logs.append(outputDir+"/log_haddTMixed_v"+s)
...
if o.doWeights:
    ...
    for s in subSamples:
        ...
        for y in yearsToFit:
            ...
            data4bFile  = getOutDir()+"/mixed"+y+"_"+mixedName+"_"+tagID+"_v"+s+"/"+histName4b 
            ...
            ttbar4bFile = getOutDirMixed()+"/TT"+y+"/"+histTT4b
...
if o.histsWithFvT: 
    ...
    for s in subSamples:
        ...
        if "2016" in years and "2017" in years and "2018" in years:
            ...
            for y in years: cmd += getOutDir()+"/mixed"+y+"_"+mixedName+"_"+tagID+"_v"+s+"_wFvT/"+histName4b+" "

            condor_jobs.append(makeCondorFile(cmd, "None", "mixedRunII_v"+s, outputDir=outputDir, filePrefix="histsWithFvT_4b_"))            
...
if o.haddSubSamples: 
    ...
    cmdTT4b       = "hadd -f "+getOutDir()+"/TTRunII/"+histNameComb4b+" "
    ...
    for s in subSamples:
        ...
        cmdTT4b += getOutDir()+"/TTRunII/"+histName4b+" "
    ...
    condor_jobs.append(makeCondorFile(cmdTT4b, "None", "TT4b", outputDir=outputDir, filePrefix="haddSubSample_"))            
...
if o.scaleCombSubSamples: 
    ...
    condor_jobs.append(makeCondorFile(cmdData4b, getOutDir(), "mixedRunII", outputDir=outputDir, filePrefix="scaleCombSubSamples_"))            

    cmdTT4b       = cmdScale + " -i "+getOutDir()+"/TTRunII/"+histNameComb4b+" "
    condor_jobs.append(makeCondorFile(cmdTT4b, getOutDir(), "TTRunII", outputDir=outputDir, filePrefix="scaleCombSubSamples_"))            
...
if o.plotsCombinedSamples:
    ...
    ttbar4bFile = getOutDir()+"/TTRunII/"+histNameComb4b
    ...
    def makeInputsForRegion(region, noFvT=False):
        ...
        for s in subSamples: 
            ...
            for y in years:
                ...
                data_obs_File  = ROOT.TFile.Open(getOutDir()+"/mixed"+y+"_"+mixedName+"_"+tagID+"_v"+s+"_wFvT/"+histName4b)

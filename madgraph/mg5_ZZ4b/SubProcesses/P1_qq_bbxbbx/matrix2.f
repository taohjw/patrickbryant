...
C     
C     Process: d d~ > z > b b~ b b~ QCD=0 QED<=4 @1
C     Process: s s~ > z > b b~ b b~ QCD=0 QED<=4 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_3_3(W(1,1),W(1,2),-GC_51,GC_58,MDL_MZ,MDL_WZ,W(1,11))
...
C     Amplitude(s) for diagram number 36
      ...
      CALL FFV1_2(W(1,1),W(1,12),GC_1,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 37
      CALL FFV2_3_0(W(1,19),W(1,2),W(1,16),-GC_51,GC_58,AMP(37))
      CALL FFV2_3_2(W(1,1),W(1,16),-GC_51,GC_58,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,19),W(1,2),W(1,12),GC_1,AMP(38))
      CALL FFV2_3_2(W(1,1),W(1,8),-GC_51,GC_58,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,12),W(1,2),W(1,18),GC_1,AMP(39))
      CALL FFV1_2(W(1,1),W(1,18),GC_1,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 40
      CALL FFV2_3_0(W(1,3),W(1,2),W(1,8),-GC_51,GC_58,AMP(40))
C     Amplitude(s) for diagram number 41
      CALL FFV2_3_0(W(1,12),W(1,2),W(1,16),-GC_51,GC_58,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL FFV2_3_0(W(1,19),W(1,2),W(1,8),-GC_51,GC_58,AMP(42))
      CALL FFV1_2(W(1,1),W(1,9),GC_1,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 43
      CALL FFV2_3_0(W(1,19),W(1,2),W(1,13),-GC_51,GC_58,AMP(43))
      CALL FFV2_3_2(W(1,1),W(1,13),-GC_51,GC_58,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,19),W(1,2),W(1,9),GC_1,AMP(44))
      CALL FFV2_3_2(W(1,1),W(1,17),-GC_51,GC_58,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 45
      CALL FFV1_0(W(1,9),W(1,2),W(1,10),GC_1,AMP(45))
      CALL FFV1_2(W(1,1),W(1,10),GC_1,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 46
      CALL FFV2_3_0(W(1,8),W(1,2),W(1,17),-GC_51,GC_58,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFV2_3_0(W(1,9),W(1,2),W(1,13),-GC_51,GC_58,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFV2_3_0(W(1,19),W(1,2),W(1,17),-GC_51,GC_58,AMP(48))
